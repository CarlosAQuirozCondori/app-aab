...
import 'schema/formularios_record.dart';
...
export 'schema/formularios_record.dart';
...
/// Functions to query FormulariosRecords (as a Stream and as a Future).
Future<int> queryFormulariosRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FormulariosRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FormulariosRecord>> queryFormulariosRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FormulariosRecord.collection,
      FormulariosRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FormulariosRecord>> queryFormulariosRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<int> queryCollectionCount(
  ...
  try {
    ...
    return count.count ?? 0; // Devuelve 0 si count es nulo
  } catch (err){
    print('Error querying $collection: $err');
    return 0; // Manejar el error y devolver un valor predeterminado
  }
